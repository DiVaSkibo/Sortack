...
class _ScrumTableState extends State<ScrumTable> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<AdvancedPlank>(
      stream: FireRources.streamPlank<AdvancedPlank>(widget.deckId, tasks.id),
                  ...
                  IconButton(
                    icon: Icon(
                      ...
                      shadows: List.generate(
                        20,
                        (index) =>
                            const Shadow(blurRadius: 0.75, color: Colours.O),
                      ),
                    ),
                  ...
                  child: Container(
                    ...
                    child: ReorderableListView.builder(
                      ...
                      header: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            _buildColumn('Deadline', flex: 3),
                            _buildColumn('Status', flex: 2),
                            _buildColumn('Priority', flex: 2),
                            _buildColumn('Points', flex: 2),
                            _buildColumn('Assignee', flex: 3),
                            _buildColumn('Tags', flex: 3),
                            _buildColumn('Notes', flex: 4),
                          ],
                        ),
                      ),
                      ...
                      onReorder: (oldIndex, newIndex) async {
                        ...
                        await FireRources.updateBlocksOrder(
                          widget.deckId,
                          tasks,
                        );
                      },
